    ...
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var ajudas = new Ajuda[]
            {
                ...
                new Ajuda{Pagina = "Registo", Nome="Password", Titulo="Password", Corpo="<p>A Password deve seguir as seguintes regras: </p><ul><li>Conter um mínimo de 6 caracteres.</li><li>Conter pelo menos 1 dígito.</li><li>Conter pelo menos 1 caracter especial (@ . _ ect...).</li><li>Conter pelo menos 1 caracter maiúsculo.</li><li>Conter pelo menos 1 caracter minúsculo.</li></ul>"},
               ...
               new Ajuda{Pagina = "Login", Nome="Password", Titulo="Password", Corpo="<p>A Password deve seguir as seguintes regras: </p><ul><li>Conter um mínimo de 6 caracteres.</li><li>Conter pelo menos 1 dígito.</li><li>Conter pelo menos 1 caracter especial (@ . _ ect...).</li><li>Conter pelo menos 1 caracter maiúsculo.</li><li>Conter pelo menos 1 caracter minúsculo.</li></ul>"},
               ...
               new Ajuda{Pagina = "AlterarPassword", Nome="Password", Titulo="Password", Corpo="<p>A Password deve seguir as seguintes regras: </p><ul><li>Conter um mínimo de 6 caracteres.</li><li>Conter pelo menos 1 dígito.</li><li>Conter pelo menos 1 caracter especial (@ . _ ect...).</li><li>Conter pelo menos 1 caracter maiúsculo.</li><li>Conter pelo menos 1 caracter minúsculo.</li></ul>"},
