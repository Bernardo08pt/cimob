...
namespace cimob.Data
{
    public class DbInitializer
    {
        ...
        {
            //Login
            context.Ajudas.Add(new Ajuda{Pagina = "Registo", Nome="Pagina", Titulo="Página de Registo", Corpo ="<p>A Página de Registo é onde pode criar a sua conta de forma a entrar na aplicação e realizar a sua candidatura.</p>" +
            ...
            //Registo
            context.Ajudas.Add(new Ajuda{Pagina = "Login", Nome="Pagina", Titulo="Página de Autenticação",
            ...
            //Recuperar Password
            context.Ajudas.Add(new Ajuda{Pagina = "RecuperarPassword", Nome="Pagina", Titulo="Página de Recuperação de Password",
            ...
            //Alterar Password
            context.Ajudas.Add(new Ajuda{Pagina = "AlterarPassword", Nome="Pagina", Titulo="Página de Alteração de Password",
        ...
        {
            context.EstadosCandidatura.Add(new EstadoCandidatura { Descricao = "Submitida", Cor = "FBAF1C", Icon = "arrow-circle-o-right" });
            ...
            context.EstadosCandidatura.Add(new EstadoCandidatura { Descricao = "Aceite", Cor = "8DD2C5", Icon = "check" });
            context.EstadosCandidatura.Add(new EstadoCandidatura { Descricao = "Recusada", Cor = "8DD2C5", Icon = "times" });
